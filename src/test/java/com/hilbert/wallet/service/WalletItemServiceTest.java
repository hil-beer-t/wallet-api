...
public class WalletItemServiceTest {
    ...
    public void testFindByType() {
        ...
        BDDMockito.given(repository.findByWalletIdAndType(Mockito.anyLong(), Mockito.any(Type.class))).willReturn(list);

        List<WalletItem> response = service.findByWalletAndType(1L, Type.EN);
